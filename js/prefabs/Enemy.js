...
KLS.Enemy = function(game, x, y, key, velocity, tilemap) {
...
KLS.Enemy.prototype = Object.create(Phaser.Sprite.prototype);
KLS.Enemy.prototype.constructor = KLS.Enemy;

KLS.Enemy.prototype.update = function(){
